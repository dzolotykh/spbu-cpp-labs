...
BMP24bit::BMP24bit(const std::string& filename) {
  ...
  bytes_between_header_and_pixels =
      new unsigned char[header->bits_offset - sizeof(BMPHeader)];
  fread(bytes_between_header_and_pixels, sizeof(unsigned char),
        header->bits_offset - sizeof(BMPHeader), f);
...
void BMP24bit::save(const std::string& filename) {
  ...
  fwrite(bytes_between_header_and_pixels, sizeof(unsigned char),
         header->bits_offset - sizeof(BMPHeader), f);
